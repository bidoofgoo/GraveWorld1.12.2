...
import com.bidoofgoo.graveworld.blocks.machines.soul_extractor.slots.SlotSoulExtractorFuel;
...
public class ContainerSoulExtractor extends Container
{
    ...
    public ContainerSoulExtractor(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 35, 17));
        this.addSlotToContainer(new SlotSoulExtractorFuel(furnaceInventory, 1, 35, 53));
        this.addSlotToContainer(new SlotFurnaceOutput(playerInventory.player, furnaceInventory, 2, 95, 35));
        this.addSlotToContainer(new SlotFurnaceOutput(playerInventory.player, furnaceInventory, 3, 129, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (!SoulExtractorRecipes.instance().getSmeltingResult(itemstack1).isEmpty())
                {
