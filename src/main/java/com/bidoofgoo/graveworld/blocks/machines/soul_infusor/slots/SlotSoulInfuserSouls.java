...
public class SlotSoulInfuserSouls extends Slot
{
    public SlotSoulInfuserSouls(IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
    ...
    {
        return TileEntitySoulInfuser.isItemSoul(stack);
    }
